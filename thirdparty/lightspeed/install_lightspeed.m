...
% Some modifications by Nadia Figueroa to run on MAC OS MOJAVE and higher
% and Windows
...
% 	options.OPTIMFLAGS = '-O -DNDEBUG';
    ...
    % OLDER MacOSX versions
    % For MAC OS X MOJAVE
    options.COMPILER = '/usr/bin/xcrun -sdk macosx10.14 clang';
	options.COMPFLAGS = '-fno-common -arch x86_64 -mmacosx-version-min=10.9 -fexceptions -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk -DMATLAB_DEFAULT_RELEASE=R2017b  -DUSE_MEX_CMD   -DMATLAB_MEX_FILE';
